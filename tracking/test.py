...
def main():
    ...
    parser.add_argument('tracker_name', type=str, default='aratrack_online', help='Name of tracking method.')
    ...
    parser.add_argument('--params__model', type=str, default='ARAtrackOnlineScore_ep0097.pth.tar', help="Tracking model path.")
