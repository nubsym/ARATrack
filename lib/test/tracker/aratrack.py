...
import cv2
import os
from lib.models.aratrack import build_aratrack
from lib.test.tracker.tracker_utils import Preprocessor_wo_mask
from lib.utils.box_ops import clip_box


class ARATrack(BaseTracker):
    def __init__(self, params, dataset_name):
        super(ARATrack, self).__init__(params)
        network = build_aratrack(params.cfg, train=False)
