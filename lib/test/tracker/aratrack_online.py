...
import cv2
import os
from lib.models.aratrack import build_aratrack_online_score
from lib.test.tracker.tracker_utils import Preprocessor_wo_mask
from lib.utils.box_ops import clip_box


class ARATrackOnline(BaseTracker):
    def __init__(self, params, dataset_name):
        super(ARATrackOnline, self).__init__(params)
        network = build_aratrack_online_score(params.cfg, train=False)
